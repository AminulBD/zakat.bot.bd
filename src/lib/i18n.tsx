...
const translations = {
  ...
  bn: {
    ...
    goldHint: "বর্তমান বাজার দর প্রতি গ্রাম অনুযায়ী হিসাব করা হবে",

    silverTitle: "রৌপ্য",
    silverDescription: "রৌপ্যালংকার ও রৌপ্য সম্পদ",
    silverWeight: "রৌপ্যের ওজন (গ্রাম)",
    silverValue: "রৌপ্যের মূল্য (টাকা)",
    silverHint: "বর্তমান বাজার দর প্রতি গ্রাম অনুযায়ী হিসাব করা হবে",
